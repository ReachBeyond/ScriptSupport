//
//  PredicateBehaviourRegistrater.cs
//
//  Author:
...
namespace ReachBeyond.VariableObjects {
	public class PredicateBehaviourRegistrater : Base.Registrater<ReachBeyond.ScriptSupport.PredicateBehaviour, PredicateBehaviourVariable> { }
}
